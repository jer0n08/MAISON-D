...
This project uses Next.js 16.x with App Router conventions.
APIs, behavior, and defaults can differ from older Next.js versions.
Before implementing framework-level features, review docs in:
